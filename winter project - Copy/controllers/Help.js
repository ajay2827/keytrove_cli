...
const Helpcommand = () =>{
    log(chalk.black.bgRed.bold("Options : ")) ;
    ...
    log(chalk.hex('#f2ba49').bold("   2. ") + chalk.green("l , list   ")+ chalk.hex('#FF69B4')("For Getting All Key Value Pairs With Their Id ")) ;
    log(chalk.hex('#f2ba49').bold("   3. ") + chalk.green("h , help   ")+ chalk.hex('#FF69B4')("For help")) ;
    log(chalk.hex('#f2ba49').bold("   4. ") + chalk.green("signup   ")+ chalk.hex('#FF69B4')("For Signup")) ;
    log(chalk.hex('#f2ba49').bold("   5. ") + chalk.green("signin   ")+ chalk.hex('#FF69B4')("For SignIn")) ;
    log(chalk.hex('#f2ba49').bold("   6. ") + chalk.green("signout   ")+ chalk.hex('#FF69B4')("For Signing Out")) ;
